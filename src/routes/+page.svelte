...
<div
	class="flex flex-col items-start max-w-2xl px-4 pb-16 mx-auto border-gray-200 dark:border-gray-700 sm:px-8"
>
	<div class="flex flex-col-reverse items-start sm:flex-row">
		<div class="flex flex-col pr-8">
			<h1 class="mb-3 text-3xl font-bold tracking-tight text-black dark:text-white md:text-5xl">
				...
				<span
					class="relative inline-block ml-2 before:absolute before:-inset-1 before:block before:-skew-y-3 before:bg-pink-500"
				>
	...
	<section class="w-full mb-16">
		...
		<div class="flex flex-col gap-6 md:flex-row">
			<FeatureCard
			    title="How to love MATHS"
			    href="/welcome"
				stringData="April 2023"
			/>
			<FeatureCard
				title="TBD"
				href="/TBD"
